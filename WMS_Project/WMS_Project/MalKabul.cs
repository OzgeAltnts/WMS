...
{
    public partial class MalKabul : UserControl
    {
        public MalKabul()
        {
            InitializeComponent();
        ...
        private void btnListeleme_Click(object sender, EventArgs e)
        {
            ...
            string getir = "Select * from MalKabul";
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            Insert into MalKabul 
            (MalKodu,MalAdi,EvrakNo,[Giris/Cikis],EvrakTipi,Tarih,Miktar) 
            values 
            (@MalKodu,@MalAdi,@EvrakNo,@GirisCikis,@EvrakTip,@Tarih,@Miktar)", baglanti);
            komut.Parameters.Clear();
            komut.Parameters.AddWithValue("@MalKodu", txtMalKodu.Text);
            komut.Parameters.Add("@MalAdi", SqlDbType.NVarChar).Value = txtMalAdi.Text;
            komut.Parameters.AddWithValue("@EvrakNo", txtEvrakNo.Text);
            komut.Parameters.AddWithValue("@GirisCikis", txtGC.Text);
            komut.Parameters.AddWithValue("@EvrakTip", txtEvrakTip.Text);
        ...
        private void dtListeleme_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMalAdi.Text = dtListeleme.CurrentRow.Cells["MalAdi"].Value.ToString();
            ...
            txtMiktar.Text = dtListeleme.CurrentRow.Cells["Miktar"].Value.ToString();
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand(" delete from MalKabul where MalKodu= '" + dtListeleme.CurrentRow.Cells["MalKodu"].Value.ToString() + "'", baglanti);
                komut.ExecuteNonQuery();
                baglanti.Close();
